  ...
  <div class="container">
    ...
    <div class="article-div">
      <?php if (!(isset($result->{"response"}->{"docs"}[0]))) {
              ...
              echo loop_through_articles($result, 0, 2);  // 3
              echo loop_through_articles($result, 2, 5);  // 2
              echo loop_through_articles($result, 5, 6);  // 1
              echo loop_through_articles($result, 6, 9);  // 3
              echo loop_through_articles($result, 9, 10); // 1
            }
      ?>
    </div>
